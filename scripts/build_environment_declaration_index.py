"""Build/query the merged pinned Lean Core, Std, and Mathlib index."""
...
from lean_prover.Mathlib import EnvironmentDeclarationIndex
...
def main() -> None:
    ...
    parser.add_argument("--project-path", type=Path, default=Path("lean_project"))
    ...
    try:
        ...
        backend.close()
    index = EnvironmentDeclarationIndex.for_project(
        project_path=arguments.project_path,
