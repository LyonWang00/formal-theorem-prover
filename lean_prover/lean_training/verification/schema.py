...
@dataclass(frozen=True)
class VerificationTaskRef:
    """Small queue envelope; the full verification task lives on disk."""
...
class VerificationResult:
    ...
    def to_json(self, *, compact_success: bool = False) -> dict[str, Any]:
        data = {
        ...
        if self.payload:
            ...
            if compact_success and self.success:
